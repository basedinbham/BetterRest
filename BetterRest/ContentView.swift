...
//  BetterRest
//
//  Created by Kyle Warren on 6/23/22.
//
    ...
    var body: some View {
        NavigationView {
            Form {
                ...
                // Alternative Section plain text (less customization available)
                Section("Desired amount of sleep") {
                    Stepper("\(sleepAmount.formatted()) hours", value: $sleepAmount, in: 4...12, step:
                                0.25)
                }
